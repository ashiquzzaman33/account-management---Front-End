...
public class CreateLCController implements Initializable {
    ...
    private void onSaveButtonClick(ActionEvent event) {
        try {
            ...
            String res = Unirest.post(MetaData.baseUrl + "lc/add-meta")
                    .field("dollar", Double.parseDouble(this.dollar.getText()))
                    .field("rate", Double.parseDouble(this.rate.getText()))
                    .field("bd_amount", Double.parseDouble(this.dollar.getText()) * Double.parseDouble(this.rate.getText()))
                    .asString().getBody();
    ...
    private void onDollarEnter(ActionEvent event) {
        String dollar = this.dollar.getText();
        String rate = this.rate.getText();
        this.bd_amount.setText(String.valueOf(Double.parseDouble(dollar) * Double.parseDouble(rate)));
    }

    @FXML
    private void onDollarEnter(KeyEvent event) {
        String dollar = this.dollar.getText();
        String rate = this.rate.getText();
        this.bd_amount.setText(String.valueOf(Double.parseDouble(dollar) * Double.parseDouble(rate)));
    }
