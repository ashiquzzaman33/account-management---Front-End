...
public class CNFReportController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        new AutoCompleteComboBoxListener<>(select_cnf);
        select_cnf.setOnHiding((e)->{
                CNF a = select_cnf.getSelectionModel().getSelectedItem();
                select_cnf.setEditable(false);
                select_cnf.getSelectionModel().select(a);
        });
        select_cnf.setOnShowing((e)->{
                select_cnf.setEditable(true);
        });
    ...
    private void onShowReportButtonClick(ActionEvent event) {
        ...
        try {
            ...
            Report r = new Report();
            r.getReport("src\\report\\CNF.jrxml", new JRBeanCollectionDataSource(v), params, "CNF Report");
