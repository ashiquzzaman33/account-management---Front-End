...
public class SellReportController implements Initializable {
    ...
    private void onShowReportButtonClick(ActionEvent event) {
        ...
        try {
            ...
            report.getReport("src\\report\\SellPurchaseLedger.jrxml", new JRBeanCollectionDataSource(v), params, "Sell Report");
            report.getReport("src\\report\\DepositVoucher.jrxml", new JRBeanCollectionDataSource(v), params, "Deposit Voucher");
