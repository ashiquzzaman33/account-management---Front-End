...
public class DepositVoucherController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        //nogod, titi, online
        this.payment_type.getItems().addAll("Cash","TT","Online");
        
        this.amount.setOnKeyReleased((e)->{
            if(!this.amount.getText().equals(""))
                this.word.setText(EnglishNumberToWords.convert(Long.parseLong(this.amount.getText())) + "taka only");
        });
    ...
    private void onSaveButtonClick(ActionEvent event) {
        ...
        try {
            ...
            Report r = new Report();
            r.getReport("src\\report\\DepositVoucher.jrxml", new JRBeanCollectionDataSource(v), params, "Deposit Voucher");
